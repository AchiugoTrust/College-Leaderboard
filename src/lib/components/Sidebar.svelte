<script lang="ts">
  ...
  const studentNavItems = [
    ...
    { href: '/dashboard/courses', label: 'My Courses', icon: 'book-open' },
    { href: '/dashboard/assignments', label: 'Assignments', icon: 'file-text' },
    { href: '/dashboard/leaderboard', label: 'Leaderboard', icon: 'trophy' },
    { href: '/dashboard/grades', label: 'Grades', icon: 'star' },
    { href: '/dashboard/transcript', label: 'Transcript', icon: 'award' }
  ];
  ...
  const lecturerNavItems = [
    ...
    { href: '/dashboard/grading', label: 'Grading', icon: 'edit-3' },
    { href: '/dashboard/exams', label: 'Exams', icon: 'clipboard' }
  ];
  
  const staffNavItems = [
    { href: '/dashboard', label: 'Dashboard', icon: 'home' },
    { href: '/dashboard/courses', label: 'All Courses', icon: 'book-open' },
    { href: '/dashboard/students', label: 'Students', icon: 'users' },
    { href: '/dashboard/lecturers', label: 'Lecturers', icon: 'user-check' },
    { href: '/dashboard/reports', label: 'Reports', icon: 'bar-chart' },
    { href: '/dashboard/settings', label: 'Settings', icon: 'settings' }
  ];
  
  $: navItems = userRole === 'student' ? studentNavItems : 
...
<div class="bg-white w-64 shadow-sm border-r border-gray-200 flex flex-col">
  <!-- Logo -->
  <div class="flex items-center px-6 py-4 border-b border-gray-200">
    ...
    <span class="text-xl font-bold text-gray-900">UniPortal</span>
  </div>
